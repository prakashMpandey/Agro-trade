...
const EditProfile = () => {
  ...
  const { user, API_URL, User_URL } = useAuthStore();
  ...
  useEffect(() => {
    ...
    setUserData({
      ...
      email: user?.email || "",
      countryCode: user.contact?.mobile?.countryCode || "+91",
      phoneNo: user?.contact?.mobile?.phoneNo || "",
      ...
      landMark: user?.contact?.landMark || "",
      addressType: user?.contact?.addressType || "home",
      country: user?.contact?.country || "India",
    });
    //     }
    //   } catch (error) {
  ...
  const handleProfileImage = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`${User_URL}/add-avatar`, {
        method: "post",
                      ...
                      isLoading ? (
                        <div className="">
                          ...
                          >
                            ...
                            >
                              <stop offset="0" stop-color="#050040"></stop>
                              <stop
                                offset=".3"
                                stop-color="#050040"
                                stop-opacity=".9"
